...
exports.wrapElements = exports.getRandomFloat = exports.distance = exports.getMousePos = exports.calcWinsize = exports.lerp = exports.preloadFonts = exports.preloadImages = void 0;
...
var Cursor = /*#__PURE__*/function () {
  ...
  _createClass(Cursor, [{
    ...
    value: function enter() {
      this.renderedStyles['scale'].current = 1.5; //this.renderedStyles['opacity'].current = 0.5;
    }
  }, {
    key: "leave",
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"js/magneticFx.js":[function(require,module,exports) {
"use strict";
...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
var splitting = (0, _splitting2.default)(); // Calculate the viewport size

var winsize = (0, _utils.calcWinsize)();
window.addEventListener('resize', function () {
  return winsize = (0, _utils.calcWinsize)();
});
var frameEl = document.querySelectorAll('.frame');

var Item = /*#__PURE__*/function () {
  function Item(el, itemsArr) {
    _classCallCheck(this, Item);

    this.DOM = {
      el: el
    };
    this.itemsArr = itemsArr; // left/right(invert) align

    this.invert = this.DOM.el.classList.contains('item--invert'); // image

    this.DOM.imgWrap = this.DOM.el.querySelector('.item__imgwrap');
    this.DOM.img = this.DOM.imgWrap.querySelector('.item__img'); // circle hover effect

    this.DOM.enterAction = this.DOM.el.querySelector('.item__enter');
    this.DOM.enterActionSVGCircle = this.DOM.enterAction.querySelector('circle'); // need to set the circle transform origin 
    ...
    this.magneticFx = new _magneticFx.MagneticFx(this.DOM.enterAction); // create the heading texts structure for the characters sliding animation (split the text into characters)

    this.editHeadingLayout(); // excerpt element

    this.DOM.excerpt = this.DOM.el.querySelector('.item__excerpt'); // excerpt link ("Read more")

    this.DOM.excerptLink = this.DOM.excerpt.querySelector('.item__excerpt-link'); // excerpt link href contains the content element's id

    this.contentId = this.DOM.excerptLink.href.substring(this.DOM.excerptLink.href.lastIndexOf('#')); // meta texts under each image

    this.DOM.metaContent = _toConsumableArray(this.DOM.el.querySelectorAll('.item__meta > .item__meta-row')); // content element and split the texts into chars/lines

    this.editContentLayout(); // back arrow button
  ...
  _createClass(Item, [{
    key: "editHeadingLayout",
    value: function editHeadingLayout() {
      this.DOM.heading = this.DOM.el.querySelector('.heading--item');
      this.DOM.itemHeadingChars = _toConsumableArray(this.DOM.heading.querySelectorAll('.char'));
      (0, _utils.wrapElements)(this.DOM.itemHeadingChars, 'span', 'char-wrap');
    }
  }, {
    key: "editContentLayout",
    value: function editContentLayout() {
      ...
      this.DOM.contentHeadingChars = _toConsumableArray(this.DOM.contentElHeading.querySelectorAll('.char'));
      (0, _utils.wrapElements)(this.DOM.contentHeadingChars, 'span', 'char-wrap');
      this.DOM.contentElText = _toConsumableArray(this.DOM.contentEl.querySelectorAll('.content__text > *'));
    }
  }, {
    key: "initEvents",
    value: function initEvents() {
      ...
      this.DOM.enterAction.addEventListener('click', function () {
        return _this.open();
      }); // same for the "read more" link

      this.DOM.excerptLink.addEventListener('mouseenter', function () {
        return _this.onMouseEnter();
      });
      this.DOM.excerptLink.addEventListener('mouseleave', function () {
        return _this.onMouseLeave();
      });
      this.DOM.excerptLink.addEventListener('click', function () {
        return _this.open();
      });
    ...
    value: function open() {
      ...
      this.isContentOpen = true; // scroll related

      document.body.classList.add('oh');
      this.DOM.contentEl.classList.add('content__article--open'); // circle element size and position

      var enterActionRect = this.DOM.enterAction.getBoundingClientRect();
      ...
      .to([frameEl, this.itemsArr.filter(function (item) {
        return item != _this2;
      }).map(function (item) {
        return item.DOM.el;
      })], {
      ...
      .to(this.DOM.enterActionSVGCircle, {
        ...
        onComplete: function onComplete() {
          return _gsap.gsap.set(_this2.DOM.enterAction, {
            x: 0,
            y: 0
          });
        }
    ...
    value: function close() {
      ...
      this.timelineHoverClose = _gsap.gsap.timeline().addLabel('start', 0).set(this.DOM.enterAction, {
        ...
        onComplete: function onComplete() {
          // scroll related
          _this3.DOM.contentEl.classList.remove('content__article--open');

          document.body.classList.remove('oh'); // scroll content element to the top

          _this3.DOM.contentEl.scrollTop = 0;
        }
      ...
      }, 'start+=0.4').to([frameEl, this.itemsArr.filter(function (item) {
        return item != _this3;
      }).map(function (item) {
        return item.DOM.el;
      })], {
...
exports.Item = Item;
},{"gsap":"../node_modules/gsap/index.js","./magneticFx":"js/magneticFx.js","./utils":"js/utils.js","gsap/gsap-core":"../node_modules/gsap/gsap-core.js","splitting/dist/splitting.css":"../node_modules/splitting/dist/splitting.css","splitting/dist/splitting-cells.css":"../node_modules/splitting/dist/splitting-cells.css","splitting":"../node_modules/splitting/dist/splitting.js"}],"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
Promise.all([(0, _utils.preloadImages)('.item__img, .content__img'), (0, _utils.preloadFonts)('ytb6dpl')]).then(function () {
  ...
  _toConsumableArray(document.querySelectorAll('.items > .item')).forEach(function (item) {
    return itemsArr.push(new _item.Item(item, itemsArr));
...
},{"./utils":"js/utils.js","./cursor":"js/cursor.js","./item":"js/item.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
